...
import com.example.pawpetshop.adapter.AdapterBank
...
import com.example.pawpetshop.model.Transaksi
...
class PembayaranActivity : AppCompatActivity() {
    ...
    fun displayBank(){
        ...
        arrBank.add(Bank("BCA", "092093871237", "Paw Petshop", R.drawable.logo_bca))
        arrBank.add(Bank("BRI", "86721349128", "Paw Petshop", R.drawable.logo_bri))
        arrBank.add(Bank("Mandiri", "02394870329", "Paw Petshop", R.drawable.logo_madiri))
