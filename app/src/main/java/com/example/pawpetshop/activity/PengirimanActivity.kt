...
import com.example.pawpetshop.adapter.AdapterKurir
...
class PengirimanActivity : AppCompatActivity() {
    ...
    private fun getOngkir(kurir:String) {
        ...
        val origin = "501" //kota pengirim
        val destination = "" + alamat!!.id_kota.toString() // kota yang dituju
        val berat = 1000
